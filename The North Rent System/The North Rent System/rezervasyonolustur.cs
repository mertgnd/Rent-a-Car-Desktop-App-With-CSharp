    ...
    public partial class rezervasyonolustur : Form
    {
        ...
        private void RezervasyonGüncelleButton_Click(object sender, EventArgs e)
        {
            if (adSoyadTextBox.Text != "" && AdresTextBox.Text != "" && TelnoMaskedTextBox.Text != "" && TCnoMaskedTextBox.Text != "" && baslangicDateTime.Text != ""
                    && bitisDateTime.Text != "")
            {
                if (rezervasyongiris.RezervasyonGuncelleme(TCnoMaskedTextBox.Text, adSoyadTextBox.Text, AdresTextBox.Text, TelnoMaskedTextBox.Text, baslangicDateTime.Text, bitisDateTime.Text))
                {
        ...
        {
            //data = new DataTable();
            //rezervasyongiris.Listele("aracEkle").Fill(data);
        }
