...
namespace The_North_Rent_System
{
    class DBOClass
    {
        static string baglantiString = "Data Source = IBRAHIM-VOENUVZ; Initial Catalog = Deneme; Integrated Security = True";
        ...
        public bool RezervasyonGuncelleme(string kimlikNumarasi,string adSoyad,string Adres,string telefonNumarasi,string baslangicTarih,string bitisTarih)
        {
            bool durum = false;
            string sorguGir = "UPDATE rezervasyonOlustur SET musteriAdSoyad = @mAd, adres = @mAdres, telefonNumarasi = @mTelno," +
               "baslangicTarih = @rBaslangic, bitisTarih = @rBitis  WHERE kimlikNumarasi=@mKimlik;";
            sqlKomut = new SqlCommand(sorguGir, baglantiS);
